...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'UserInfoPage',
          path: '/userInfoPage',
          builder: (context, params) => UserInfoPageWidget(
        ...
        FFRoute(
          name: 'MessengerPage',
          path: '/messengerPage',
          builder: (context, params) => const MessengerPageWidget(),
        ),
        FFRoute(
          name: 'ChatPage',
          path: '/chatPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => GamePageWidget(
            game: params.getParam(
              ...
              ParamType.DataStruct,
              isList: false,
              structBuilder: GameStruct.fromSerializableMap,
            ),
            globalIndex: params.getParam(
              'globalIndex',
              ParamType.int,
            ),
          ),
        ...
        FFRoute(
          ...
          path: '/finishedGamePage',
          builder: (context, params) => FinishedGamePageWidget(
            game: params.getParam(
              'game',
              ParamType.DataStruct,
              isList: false,
