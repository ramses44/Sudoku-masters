...
CellStruct cellStructFromCell(Cell cell) {
  return CellStruct(
      number: cell.number,
      trueNumber: cell.expectedNumber,
...
Future<SudokuStruct> generateSudoku(int size, Difficulty difficulty) async {
  ...
  return SudokuStruct(
      ...
      field: List.generate(
          size * size, (i) => cellStructFromCell(sudoku[i ~/ size][i % size])));
}
