            ...
            children: [
              Column(
                ...
                children: [
                          ...
                          child: Builder(
                            builder: (context) {
                              ...
                              return Column(
                                mainAxisSize: MainAxisSize.max,
                                children:
                                    List.generate(cellX.length, (cellXIndex) {
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(8.0, 30.0, 8.0, 30.0),
                    child: Builder(
                      builder: (context) {
                        final rowNum = functions
                            .range(
                                0,
                                widget.game!.sudoku.size ~/
                                        (math.min(9, widget.game!.sudoku.size) +
                                            1) +
                                    1)
                            .toList();
                        return Column(
                          mainAxisSize: MainAxisSize.max,
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: List.generate(rowNum.length, (rowNumIndex) {
                            ...
                            return Builder(
                              builder: (context) {
                                ...
                                return Row(
                                  mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: List.generate(buttonNumber.length,
                                      (buttonNumberIndex) {
                                    ...
                                    return Align(
                                      ...
                                      child: FFButtonWidget(
                                        ...
                                        text: functions
                                            .tableDataFromNum(buttonNumberItem),
                                        options: FFButtonOptions(
                            ...
                            builder: (context) {
                              if (_model.eraserMode) {
                                return FFButtonWidget(
                                  onPressed: () async {
                                    setState(() {
                                      _model.eraserMode = !_model.eraserMode;
                                    });
                                  },
                                  text: FFLocalizations.of(context).getText(
                                    'cifju3wz' /* Ластик */,
                            ...
                            builder: (context) {
                              if (_model.pencilMode) {
                                return FFButtonWidget(
                                  onPressed: () async {
                                    setState(() {
                                      _model.pencilMode = !_model.pencilMode;
                                    });
                                  },
                                  text: FFLocalizations.of(context).getText(
                                    'f0a7oq1s' /* Карандаш */,
