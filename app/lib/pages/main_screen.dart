...
class _MainScreenState extends State<MainScreen> with WidgetsBindingObserver {
  ...
  static const unavailableSizeDiffPairs = ["16 Hard", "16 Medium"];
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: DropdownButtonFormField(
                              ...
                              items: availableSizes.where((n) => !unavailableSizeDiffPairs.contains([n, selectedDifficulty == null ? "" : difficultyToString(selectedDifficulty!)].join(" ")))
                      ...
                      Container(
                          ...
                          child: DropdownButtonFormField(
                              ...
                              items: Difficulty.values.where((n) => !unavailableSizeDiffPairs.contains([selectedSize, difficultyToString(n)].join(" ")))
